<template>
  <div class="single-job">
    <Hero
      ...
      type="reduced"
      class="single"
      :block-title="pageData.data.title"
      :block-content="pageData.data.description.slice(0, 118)"
    />
    <div class="container inner-wrap">
      <div class="split">
        <div v-html="pageData.data.description">
        </div>
      </div>
      <FormCareer :job-id="pageData.data.jobs_id"></FormCareer>
    </div>
  </div>
</template>
